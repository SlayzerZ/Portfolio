...
const money = {
    ...
    livre: 1.14,
    bitcoin: 40000,
    cfa: 0.001524390243902439
}
function Entry() {
    let entry = [buttons[0], buttons[1], buttons[2], buttons[3], buttons[4]]
    for (let i = 0; i < entry.length; i++) {
        entry[i].addEventListener('click', function (e) {
            ...
            if (entryData == "cfa") {
                devise_entrée = read_prop(money, "cfa")
            }
        }, false);
    }
...
function Output() {
    let output = [buttons[5], buttons[6], buttons[7], buttons[8], buttons[9]]
    for (let i = 0; i < output.length; i++) {
        output[i].addEventListener('click', function (e) {
            ...
            if (outputData == "cfa") {
                devise_sortie = read_prop(money, "cfa")
            }
        }, false);
    }
